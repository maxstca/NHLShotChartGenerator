...
#Sourced from github user mrbilltran. Saved here for backup purposes.
#Original file: https://raw.githubusercontent.com/mrbilltran/the-win-column/master/nhl_rink_plot.
